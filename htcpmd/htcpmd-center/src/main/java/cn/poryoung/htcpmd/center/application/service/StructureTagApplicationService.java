...
public class StructureTagApplicationService extends BaseApplicationService {
    @Autowired
...
//        List<HtcpmdStructureTag> list = htcpmdStructureTagDomainService.selectHtcpmdStructureTagList(htcpmdStructureTag);
        Page<StructureTagDoc> structureTagDocPage = structureTagDocDomainService.findAll(PageSupport.getPageableBeginWith0());
        return getDataTable(structureTagDocPage);
    }
    ...
    @PostMapping("/export")
    public void export(HttpServletResponse response, StructureTagDoc structureTagDoc) {
