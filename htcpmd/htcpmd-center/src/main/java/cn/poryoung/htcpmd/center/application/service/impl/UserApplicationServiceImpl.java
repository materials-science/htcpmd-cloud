package cn.poryoung.htcpmd.center.application.service.impl;

import cn.hutool.core.bean.BeanUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import cn.poryoung.htcpmd.center.application.service.UserApplicationService;
import cn.poryoung.htcpmd.center.infrastructure.proxy.UserProxyService;
...
public class UserApplicationServiceImpl implements UserApplicationService {
    ...
    public R<?> userinfo(@PathVariable("id") String userId) throws BusinessException, SystemException {
        BusinessException.throwExceptionIfTrue(StrUtil.isEmpty(userId), BusinessErrorStatusEnum.BUSINESS_ERROR.getCode(), "用户信息不存在(请检查网关配置)");
        // get user info from cache
        LoginUser respDto = BeanUtil.copyProperties(redisService.getCacheMapValue(HtcpmdCommonConstant.REDIS_KEY_USER, userId), LoginUser.class);
    ...
    public R<?> profile() throws BusinessException, SystemException {
