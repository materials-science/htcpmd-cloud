<template>
  <d2-container class="structures-import-container" type="card">
      ...
      <el-col :xl="6" :lg="8" :md="12">
        ...
        >
          ...
          <el-form-item>
            <el-button
              type="primary"
              @click="importStructuresFormSubmit('import_structures_form')"
              plain
              >Submit</el-button
            >
          </el-form-item>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="example_dialog_visible = false"
          >close</el-button
        >
      </span>
    </el-dialog>
...
export default {
  name: "structures-import-from-aiida",
  data() {
    return {
    ...
    importStructuresFormSubmit(formName) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          this.$api.AddObj("/structures/import/", this.fileData).then(resp => {
            if (resp.code == 0) {
